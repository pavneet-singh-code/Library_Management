...
const LoginPage = () => {
    return (
        // Outer container: Dark background to match your screenshot
            ...
            <div className="w-full max-w-6xl h-full max-h-187.5 bg-[#2D2926] rounded-[3rem] overflow-hidden shadow-2xl flex flex-col md:flex-row relative border border-white/5">
                ...
                <div className="w-full md:w-1/2 p-8 lg:p-16 flex flex-col justify-center z-10 relative">
                    <div className="max-w-md mx-auto w-full">
                        ...
                        {/* FIXED: Google Button Visibility (Light border and white text) */}
                        <button className="w-full bg-white/5 border border-white/10 text-white py-4 rounded-full flex items-center justify-center gap-3 font-bold hover:bg-white/10 transition-all mb-10 shadow-lg group">
                            <svg
                                width="20"
                                height="20"
                                viewBox="0 0 24 24"
                        ...
                        <form className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    {/* FIXED: Text is now FORCED to dark brown (the background color) so it's visible on white */}
                                    <input
                                        type="email"
                                        placeholder="username@email.com"
                                        className="w-full bg-white border-2 border-transparent focus:border-accent outline-none rounded-full py-4 pl-16 pr-6 text-[#2D2926] font-bold shadow-xl transition-all placeholder:text-[#2D2926]/30 z-10"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end px-4">
                                <a
                                    href="#"
                                    className="text-sm font-bold text-accent hover:underline italic"
                                >
                                    Forgot password?
                                </a>
                            </div>

                            <button className="w-full bg-accent text-white py-4 rounded-full font-bold text-xl hover:brightness-110 transition-all shadow-2xl flex items-center justify-center gap-3 active:scale-[0.98]">
                                Sign In <ArrowRight size={22} />
                            </button>
                        </form>

                        <p className="mt-10 text-center text-white/40 font-bold">
                            New here?{" "}
                            <Link
                                href="/signup"
                ...
                <div className="hidden md:flex w-1/2 bg-accent relative flex-col items-center justify-center p-12 text-white overflow-hidden">
                    ...
                    <div className="z-10 text-center flex flex-col items-center">
                        ...
                        <div className="mb-8 w-64 bg-white/10 p-8 rounded-[3rem] backdrop-blur-md border border-white/20 flex items-center justify-center">
                            <div className="text-white/40 italic font-serif">
                        ...
                        <p className="text-lg font-bold opacity-80 max-w-xs leading-relaxed">
                            "All your academic needs in one single place."
                        </p>
                    </div>
